...
<table height="100%" width="1000px" cellspacing="2" border="0" align="center" class="maintable">
	...
	<tr valign="top">
		<td width="200px">
			<?php echo "Logged in as:<br />".$_SESSION["EVEOTSusername"]."<br />"; ?>
			...
			<a href="admin_panel.php?menu=members_audit">Audit Members</a><br /><br />
			...
			<?php
				...
				switch ($menu) {
				    case "main":
						...
						echo "<li><strong>Security Level (SL) -</strong> This is the level of control someone has.<br /> 1 = Super admin. Able to edit, delete and create other admins via the Audit Administrators menu.<br /> 2 = Normal admin. Can only make changes to the whitelist. Cannot edit, delete or create other admins (recommended).<br /><br /></li>";
					...
					case "admins_add";
						...
						if ($securityLevel !== "1") {
							...
							// Using the Character ID, get thier name as it appears in-game
							try {
					...
					case "admins_audit":
						...
						if ($securityLevel !== "1") {
							...
							// Audit
							echo "<strong>Add administrator:</strong><br /><font size=\"2\">Character Name: Must be their exact in-game name.<br />Password: a-Z & 0-9 only.<br />Security Level: 1 = Super Admin. 2 = Disables Audit Administrators.</font>";
							?>		
						...
						if ($securityLevel !== "1") {
							...
							SQLconnect('open');
								...
								while ($row = mysql_fetch_array($query)) {
									...
									echo "<td><a href=\"?menu=members_edit&id=".$id."\"><img src=\"images/edit.png\" border=\"0\"></a></td>";
									echo "</tr>";
								}
								echo "</table>";
							SQLconnect('close');
