 ...
 *
 * $Id: Text.php 3/19/2011 10:09:59 scp@orilla $
 *
...
class TeamSpeak3_Viewer_Html implements TeamSpeak3_Viewer_Interface
{
   ...
   * @var string
   */
  protected $pattern = "<table id='%0' class='%1'><tr class='%2'><td class='%3'>%4</td><td class='%5' title='%6'>%7 %8</td><td class='%9'>%10%11</td></tr></table>\n";
